                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="example-select" name="status">
                                                ...
                                                <option value="Otoshel" <?php if($status=='Otoshel'){echo 'selected';}?>>Otoshel</option>
                                                <option value="Ne bespokoit"<?php if($status=='Ne bespokoit'){echo 'selected';}?> >Не беспокоить</option>
                                            </select>
                                        </div>
                                    </div>
