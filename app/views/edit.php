                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="speciality" value="<?php echo $speciality;?>">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Телефон нөмірі</label>
                                    <input type="text" id="simpleinput" class="form-control" name="telnumber" value="<?php echo $telnumber;?>">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Мекен-жайы</label>
                                    <input type="text" id="simpleinput" class="form-control" name="address" value="<?php echo $address;?>">
                                </div>
