            ...
            <form action="" method="post">
                ...
                <div class="form-group text-left">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="rememberme">Мені есте сақтау</label>
                    </div>
                </div>
                <button type="submit" class="btn btn-default float-right">Кіру</button>
            </form>
        </div>
        <div class="blankpage-footer text-center">
            Нет аккаунта? <a href="/"><strong>Тіркелу</strong>
        </div>
    </div>
